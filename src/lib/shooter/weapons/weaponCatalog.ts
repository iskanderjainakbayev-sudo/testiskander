...
export const weaponCatalog: WeaponDefinition[] = [
  weapon("ar9", "AR-9", auto(24, 96, 105, 1100, 1), ["optic", "muzzle", "underbarrel", "magazine"]),
  weapon("volt-smg", "VOLT SMG", auto(36, 144, 68, 1350, 1), ["optic", "muzzle", "magazine"]),
  weapon("sable-sr", "SABLE SR", pierce(5, 30, 680, 1750, 3), ["optic", "muzzle", "magazine"]),
  weapon("breach-8", "BREACH-8", scatter(8, 40, 560, 1550, 1.05, 8, 0.09), ["muzzle", "underbarrel", "magazine"]),
...
function auto(magazine: number, reserve: number, fireDelay: number, reloadTime: number, damage: number): WeaponStats {
  return { magazine, reserve, fireDelay, reloadTime, damage, fireMode: "AUTO", pellets: 1, spread: 0 };
}

function burst(magazine: number, reserve: number, fireDelay: number, reloadTime: number, damage: number): WeaponStats {
  return { magazine, reserve, fireDelay, reloadTime, damage, fireMode: "BURST", pellets: 1, spread: 0 };
}
...
function scatter(magazine: number, reserve: number, fireDelay: number, reloadTime: number, damage: number, pellets: number, spread: number): WeaponStats {
  return { magazine, reserve, fireDelay, reloadTime, damage, fireMode: "SCATTER", pellets, spread };
}

function pierce(magazine: number, reserve: number, fireDelay: number, reloadTime: number, damage: number): WeaponStats {
  return { magazine, reserve, fireDelay, reloadTime, damage, fireMode: "PIERCE", pellets: 1, spread: 0 };
}

function double(magazine: number, reserve: number, fireDelay: number, reloadTime: number, damage: number): WeaponStats {
  return { magazine, reserve, fireDelay, reloadTime, damage, fireMode: "DOUBLE", pellets: 2, spread: 0.035 };
}
